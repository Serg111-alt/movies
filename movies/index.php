  ...
  -webkit-overflow-scrolling: touch;
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
                    ...
                    <div class="item">
            <div class="img-fill">
                <img src="images/western.jpg" width = "922" height = "500" alt="">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="images/alone-ranger2.jpg" width = "922" height = "500" alt="">
                <div class="text-content">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="images/marvel.jpg" width = "922" height = "500" alt="">
                <div class="text-content">
                </div>
          <!-- // Item -->
          <!-- Item -->
    ...
    <div class="container">
            <div class="row">
                    ...
                    <iframe src="form.php" width = "1500" height = "600" frameborder="0"></iframe>    
    ...
    <div class="container">
        ...
        <iframe src="content.php" width="1600" height="1650"></iframe>
